...
// Source: github.com/nbvehbq/go-metrics-harvester/internal/agent (interfaces: Publisher)
...
func (m *MockPublisher) Publish(arg0 context.Context, arg1 []metric.Metric) error {
	m.ctrl.T.Helper()
